...
def fused_moe_mxfp4(
    ...
    #TODO: Add doc
    """
    if triton.runtime.driver.active.get_current_target().arch == "gfx936":
        from aiter.ops.triton.moe_op_mxfp4_soft import fused_moe_mxfp4_soft

        return fused_moe_mxfp4_soft(
            A,
            B,
            C,
            A_scale,
